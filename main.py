	...
	if not st.session_state.reset:
		...
		if st.session_state.success:
			with st.expander("What do these words mean??"):
				...
				st.subheader(f"  ")
				if st.checkbox("Note on these results"):
					st.write("If a Wikipedia search returns many results, the Wikipedia summary dislpayed here could be any of them.  Use the link to see the list!")
