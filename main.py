...
st.set_page_config(page_title="Anagramizer", page_icon='exploding head', layout="centered", initial_sidebar_state="auto", menu_items=None)
...
st.title("use-another-word-for-the-selectbox-default")
