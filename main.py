...
if st.session_state.name != "":	
	...
	if st.session_state.reset:
		...
		if st.session_state.success or st.session_state.jump_to_end: 
			...
			components.html("""<script src="https://platform.twitter.com/widgets.js" charset="utf-8"></script><a href='https://twitter.com/share?text=tweet_data' class="twitter-share-button" data-show-count="false">Tweet</a>""")
