...
if st.session_state.name != "":	
	...
	if st.session_state.reset:
		...
		if st.session_state.success or st.session_state.jump_to_end: 
			...
			tweet_data = f"""{st.session_state.anagram if st.session_state.user_anagram else ' '.join([i for i in st.session_state.res if i != "Select a word!"])}!!!"""
			share_link = f"""https://twitter.com/share?text={tweet_data}&url=''"""
